...
The inbox list is wrapped in a FlatPack outlined card inside a 2-column grid. Inbox, settings, and menu views use FlatPack components and Tailwind utility classes only.
